            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mt-0 lg:mr-auto">
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h1"
                  className="mx-auto mt-8 max-w-4xl text-3xl text-balance max-md:font-semibold md:text-5xl lg:mt-16 xl:text-[3.25rem]"
                >
                ...
                >
                  A conversational AI that pinpoints what hiring managers see.
                </TextEffect>
