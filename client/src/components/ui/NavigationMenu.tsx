...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      className={cn(
        "hover:bg-accent focus:bg-accent focus:text-accent-foreground focus-visible:ring-ring/50 data-[active]:bg-accent data-[active]:text-accent-foreground data-[active]:focus:bg-accent data-[active]:hover:bg-accent [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
